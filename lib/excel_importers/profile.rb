...
module ExcelImporters
  class Profile < Base
    JOB_LEVEL_CODES = {
      ...
      'APOYO A LA SECRETARIA ALCALDIA' => 'director',
      'CONCEJAL PRESIDENTE DE DISTRITO' => 'director',
      ...
      'JEFE/A DE SECRETARÍA' => 'director',
      'JEFE/A DE SECRETARIA' => 'director',
      'PENDIENTE ADSCRIPCION' => 'director',
      'PRESIDENTE TRIBUNAL' => 'director',
      'PRIMER TENIENTE DE ALCALDE' => 'director',
