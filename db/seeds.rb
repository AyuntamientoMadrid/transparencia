...
Department.create([
  { name: "Dirección General de Transparencia",
    area: Area.where(name: "Participación Ciudadana, Transparencia y Gobierno Abierto" ),
...
Se ofrecerá un servicio eficaz que facilite a la ciudadanía el ejercicio del derecho a presentar sugerencias, reclamaciones y avisos sobre deficiencias en los servicios prestados con el objetivo de, con su colaboración, mejorar la gestión municipal.",
	directives: "-Situar a la Ciudad de Madrid a la cabeza en materia de transparencia aprobando medidas que aseguren la apertura de datos y su reutilización.  -Asegurar la trazabilidad de las decisiones públicas abriendo los procesos de decisión desde las reuniones iniciales. -Garantizar la protección de los datos personales de la ciudadanía en su relación con el Ayuntamiento y específicamente en el desarrollo de las políticas de transparencia con especial interés en los métodos de anonimización de datos. - Facilitar el acceso de la ciudadanía a los servicios municipales potenciando la gestión electrónica como elemento fundamental de transparencia. - Impulsar un sistema unificado que facilite a la colaboración ciudadana en la gestión municipal presentando avisos, sugerencias y reclamaciones."	
  },  
