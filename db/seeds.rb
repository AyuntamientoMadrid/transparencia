...
Por otra parte, se incentivará la participación ciudadana en aspectos relativos al voluntariado; se pretende que el número de voluntarios (que actualmente asciende a 10 000) se incremente todo los años, así como el tipo de actividades en las que colaboran, y que el voluntariado se integre como un elemento más que caracterice el ejercicio responsable de la ciudadanía.",
	directives: "<ul><li>Que los ciudadanos puedan hacer propuestas, que sus conciudadanos puedan apoyar esas propuestas, y que si estas tienen el apoyo necesario sean llevadas a la práctica por el Gobierno Municipal.</li><li>Que una parte significativa de las decisiones de Gobierno sea sometida a consulta de la ciudadanía.</li><li>Implicar a la ciudadanía en los asuntos públicos, al objeto de su participación voluntaria y altruista en diversas tareas de carácter social.</li><li>Crear nuevas fórmulas de innovación social que puedan implantarse en la organización municipal para la mejora de los servicios públicos o la organización social.</li></ul>".html_safe
  }
])
